...
# Methodology
이미지 feature로부터 visual latent를 생성하여 이를 k,v로 하는 디코더를 통해 waypoint를 예측하는 perception-free 방식과 BEV feature를 생성하고 이를 visual latent로써 활용하여 moition predction과 map construction도 같이 진행하는 perception-based 방식을 제안
![overall](/assets/images/posts_img/law/law_overall.png)
...
![nusc result](/assets/images/posts_img/law/law_nusc.png)

**Result on NAVSIM test set.**
![navsim result](/assets/images/posts_img/law/law_navsim.png)

**Result on CARLA Town05 Long.**
![carla result](/assets/images/posts_img/law/law_carla.png)

**Ablation study of latent prediction on nuScenes.**
![ablation](/assets/images/posts_img/law/law_ab1.png)